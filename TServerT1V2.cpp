...
TServerT1V2::TServerT1V2(string t_serverIP, int t_serverPort, bool verbose) {
    this->active = true;
    ...
    print(fhesiPubKey);
    print("TServerT1V2 SECRET KEY");
    print(fhesiSecKey);
    print("TServerT1V2 SWITCH MATRIX ");
    print(keySwitchSI);
...
void TServerT1V2::socketListen() {
    listen(this->t_serverSocket, 5);
    print("Server is listening...");

}

void TServerT1V2::socketAccept() {
    int socketFD;
...
void TServerT1V2::handleRequest(int socketFD) {
    ...
    if (message == "C-PK") {
        ...
        this->active = false;
        print("TServerT1V2 STOP AND EXIT");
    } else {
...
bool TServerT1V2::sendMessage(int socketFD, string message) {
...
string TServerT1V2::receiveMessage(int socketFD, int buffersize) {
...
ifstream TServerT1V2::receiveStream(int socketFD, string filename) {
    uint32_t size;
    auto *data = (char *) &size;
...
void TServerT1V2::log(int socket, string message) {
    if (this->verbose) {
        sockaddr address;
...
void TServerT1V2::receiveEncryptionParamFromClient(int socketFD) {
...
void TServerT1V2::initializeKM(int socketFD) {
...
void TServerT1V2::classifyToCluster(int socketFD) {
    this->sendMessage(socketFD, "T-READY");
...
bool TServerT1V2::sendStream(ifstream data, int socket) {
