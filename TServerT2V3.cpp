...
void TServerT2V3::calculateCentroid(int socketFD) {
...
void TServerT2V3::calculateVariance(int socketFD) {
    this->sendMessage(socketFD, "T-READY");
...
Plaintext TServerT2V3::newCentroidCoef(const Plaintext &sum, long mean) {
...
ifstream TServerT2V3::centroidCoefToStream(const Ciphertext &centroid) {
