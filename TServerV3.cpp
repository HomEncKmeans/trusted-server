...
TServerV3::TServerV3(string t_serverIP, int t_serverPort, bool verbose) {
    this->active = true;
    ...
    print(fhesiPubKey);
    print("TServerV3 SECRET KEY");
    print(fhesiSecKey);
    print("TServerV3 SWITCH MATRIX ");
    print(keySwitchSI);
...
void TServerV3::socketListen() {
    listen(this->t_serverSocket, 5);
    print("Server is listening...");

}

void TServerV3::socketAccept() {
    int socketFD;
...
void TServerV3::handleRequest(int socketFD) {
...
bool TServerV3::sendMessage(int socketFD, string message) {
...
string TServerV3::receiveMessage(int socketFD, int buffersize) {
...
ifstream TServerV3::receiveStream(int socketFD, string filename) {
    uint32_t size;
    auto *data = (char *) &size;
...
void TServerV3::receiveEncryptionParamFromClient(int socketFD) {
...
void TServerV3::initializeKM(int socketFD) {
...
void TServerV3::classifyToCluster(int socketFD) {
    this->sendMessage(socketFD, "T-READY");
...
unsigned TServerV3::extractClusterIndex() {
...
void TServerV3::calculateCentroid(int socketFD) {
